...
// 2D joystick pad — returns normalized displacement (-1..1) per axis.
// Quadratic response for fine center control.
inline glm::vec2 Joystick(const char* id, float size = 80.f) {
